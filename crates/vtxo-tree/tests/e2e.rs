...
//!
//! Prerequisites:
//!   cd crates/vtxo-tree && docker compose up -d
//!
//! Run:
//!   cargo test -p vtxo-tree --test e2e -- --ignored --test-threads=1
//!
...
use vtxo_tree::tree::{build_tree, build_tree_with_fee};
use vtxo_tree::tx::{aggregate_secret_key, p2tr_script, sign_tx};
