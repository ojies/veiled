...
use crate::types::{ChildRandomness, Name};
...
pub fn derive_child_secret_key(child_randomness: &ChildRandomness, username: &Name) -> [u8; 32] {
...
pub fn derive_pseudonym(
    ...
    let csk = derive_child_secret_key(child_randomness, username);
...
mod tests {
    use super::*;
    use crate::credential::derive_child_randomness;
    ...
    fn child_key_independent_from_nullifier() {
        ...
        use crate::nullifier_v2::derive_nullifier;
