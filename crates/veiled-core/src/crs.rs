...
use crate::types::{BlindingKey, Commitment, Name, Nullifier};
...
impl Crs {
    ...
    pub fn setup(providers: Vec<ServiceProvider>) -> Self {
        let l = providers.len();
    ...
    /// Returns the number of service providers L.
...
mod tests {
    ...
    fn make_providers(count: usize) -> Vec<ServiceProvider> {
        (0..count)
